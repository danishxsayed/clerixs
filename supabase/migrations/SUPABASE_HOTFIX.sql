-- [PHASE 29] HOTFIX FOR DUPLICATE CLINIC AUTO-PROVISIONING BUG

-- Modify the core Trigger to skip auto-provisioning a new clinic if the user is a staff invite
...
BEGIN
    ...
    -- CRITICAL FIX: Skip provisioning default org if this is a staff invite link
