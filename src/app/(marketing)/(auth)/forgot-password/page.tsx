...
import { ChevronRight, Mail, Lock, HelpCircle } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-10">
           <div className="space-y-4">
             ...
             <p className="text-zinc-400 text-lg leading-relaxed max-w-md">
               We'll send you a secure link to reset your password and get you back into your clinic's dashboard.
             </p>
           </div>
        </div>
      </div>
           ...
           <div className="space-y-6">
             {success ? (
                 <motion.div 
                   ...
                   className="rounded-xl bg-emerald-50 p-6 text-base text-emerald-800 text-center border border-emerald-200 font-bold"
                 >
                     {success}
                 </motion.div>
             ) : (
