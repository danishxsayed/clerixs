...
export default async function ResetPasswordPage({
  ...
  return (
    <div className="flex min-h-screen w-full bg-white light overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-10">
           <div className="space-y-4">
             ...
             <p className="text-zinc-400 text-lg leading-relaxed max-w-md">
               Please create a strong password to ensure your clinic's data remains safe and accessible only to you.
             </p>
           </div>
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center p-6 sm:p-12 relative bg-white">
        <div className="w-full max-w-md space-y-8 relative z-10">
           ...
           <div className="relative flex flex-col items-center mb-10">
             ...
             <div className="text-center space-y-2">
               ...
               <p className="text-slate-500 font-medium">Please enter your new strong password below.</p>
             </div>
           </div>
           ...
           <div className="space-y-6">
             {success ? (
                  ...
                  >
                      <div className="rounded-xl bg-emerald-50 p-6 text-base text-emerald-800 text-center border border-emerald-200 font-bold">
                          {success}
                      </div>
                      <Button asChild className="w-full h-14 text-lg font-bold bg-primary text-white hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-[0.98] rounded-xl">
                   ...
                   <div className="space-y-2">
                     ...
                     <div className="relative group">
                       ...
                       <PasswordInput 
                         ...
                         required 
                         minLength={6}
                         className="h-14 pl-12 bg-white text-slate-900 border-slate-200 focus-visible:ring-primary/20 focus-visible:border-primary transition-all text-base rounded-xl shadow-none [&>input]:pl-12" 
                       />
                     </div>
                   </div>
