    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-slate-50 light">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-lg border border-slate-200">
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Start your trial for Clerixs</p>
        </div>

        <form action={signup} className="space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-medium leading-none text-slate-700" htmlFor="fullName">Full Name</label>
            <Input
              id="fullName"
              name="fullName"
              type="text"
